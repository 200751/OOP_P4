...
var sole = document.getElementById("shoe_sole");
...
adidasButton.addEventListener("click", function() {
    shoe.style.fill !== "white" ? (shoe.style.fill = "white", shoe.style.stroke = "#000", sole.style.stroke = "#000") : (shoe.style.fill = "none");
...
nikeButton.addEventListener("click", function() {
    shoe.style.fill !== "black" ? (shoe.style.fill = "black", shoe.style.stroke = "#fff", sole.style.stroke = "#fff") : (shoe.style.fill = "none", shoe.style.stroke = "#000", sole.style.stroke = "#000");
...
spongebobButton.addEventListener("click", function() {
    shoe.style.fill !== "yellow" ? (shoe.style.fill = "yellow", shoe.style.stroke = "#000", sole.style.stroke = "#000") : (shoe.style.fill = "none");
